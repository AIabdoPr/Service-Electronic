              ...
              child: Form(
                ...
                child: ListView(
                  children: [
                    ...
                    //               ? "${(controller.user.balance * double.parse(user.platformSettings.platformCurrency.dPrices[user.platformSettings.displayCurrency.id.toString()]?['buy'].toString() ?? '0')).toStringAsFixed(3)} ${user.platformSettings.displayCurrency.char}"
                    //               : "${(controller.user.balance * double.parse(user.platformSettings.platformCurrency.dPrices[user.platformSettings.displayCurrency.id.toString()]?['sell'].toString() ?? '0')).toStringAsFixed(3)} ${user.platformSettings.displayCurrency.char}",
                    //           style: const TextStyle(
                    //               fontWeight: FontWeight.bold,
                    //               color: Color.fromARGB(255, 17, 17, 17)),
                    //         ),
                        ...
                        items: [
                          ...
                          for (CurrencyModel currency
                            ...
                            DropdownMenuItem(
                              value: '${currency.id}',
                              child:
                                  Text('${currency.name} (${currency.char})'),
                            ),
                        ],
                        onChanged: (value) {
                          if (value != null) {
                          ...
                          if (controller.currenctCurrencyId != '-1')
                            for (String item in controller
                              ...
                              Container(
                                ...
                                color: const Color.fromARGB(253, 201, 253, 203),
                          ...
                          if (controller.currenctCurrencyId != '-1') ...[
                            Container(
                              margin: const EdgeInsets.only(
                                  right: 40, left: 40, top: 10, bottom: 5),
                              child: myTextFormField(
                                enabled: true,
                                isNumber: true,
                                mycontroller: controller.dibosit,
                                onChanged: controller.calculateRechareBalance,
                                valid: (v) {
                                  if (v!.isEmpty) {
                                    return "18".tr;
                                  } else if ((double.tryParse(v) ?? 0) <= 10) {
                                    return '47'.tr;
                                  }
                                },
                                labeltext: "30".tr,
                                ...
                                child: InkWell(
                                    ...
                                    child: Image(
                                      image: controller.imageproof != null
                                          ? FileImage(controller.imageproof!)
                                              as ImageProvider
                                          : const AssetImage(
                      ...
                      Column(
                        children: [
                          if (controller.currenctCurrencyId != '-1')
                            Container(
                              margin: const EdgeInsets.only(
                                  right: 40, left: 40, top: 5, bottom: 0),
                              child: myTextFormField(
                                enabled: true,
                                isNumber: true,
                                ...
                                valid: (v) {
                                  if (v!.isEmpty) {
                                    return "18".tr;
                                      ...
                                      // (double.tryParse(v) ?? 0) >
                                      //     controller
                                      //         .platofromCurrencies[controller
                                      //             .currenctCurrencyId]!
                                      //         .maxReceive
                                      ) {
                                    return "148".tr;
                              ...
                              Container(
                                ...
                                child: myTextFormField(
                                  ...
                                  mycontroller:
                                      controller.dataControllers[name],
                                  valid: (text) {
                                    if (controller.errors.containsKey(name)) {
                          ...
                          //       hintText: "139".tr,
                          //       suffixIcon: const Icon(Icons.history_edu),
                          //       border: const OutlineInputBorder(
                          //           borderRadius: BorderRadius.all(
                          //               Radius.circular(12))),
                          //     ),
