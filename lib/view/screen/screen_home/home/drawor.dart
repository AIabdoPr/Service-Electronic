          ...
          child: ListView(
            ...
            children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          ...
                          borderRadius: BorderRadius.all(Radius.circular(12))),
                      child: Text(
                        // "${user.value!.balance.toStringAsFixed(2)} DZD".tr,
                        'balance'.tr.replaceAll('{balance}',
                            user.value!.balance.toStringAsFixed(2)),
                        style: const TextStyle(
                            fontWeight: FontWeight.bold,
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          ...
                          borderRadius: BorderRadius.all(Radius.circular(12))),
                      child: Text(
                        'balance'.tr.replaceAll(
                            '{balance}', '${user.value!.checkingBalance}'),
                        style: const TextStyle(
                            fontWeight: FontWeight.bold,
                            color: Color.fromARGB(255, 17, 17, 17)),
                      ),
              ...
              Row(
                children: [
                  InkWell(
                    onTap: user.value!.identityVerifyStatus.isNotVerifted
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: user.value!.identityVerifyStatus.secendColor,
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            user.value!.identityVerifyStatus.name,
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: user.value!.identityVerifyStatus.color,
              ...
              if (user.value!.platformSettings.servicesStatus['transfers'] ==
                  'active')
                ListTile(
                  leading: const Icon(
                    Icons.wallet,
              ...
              if (user.value!.platformSettings.servicesStatus['offers'] ==
                  'active')
                ListTile(
                  leading: const Icon(
              ...
              if (user.value!.platformSettings.servicesStatus['store'] ==
                  'active')
                ListTile(
                  leading: const Icon(
                    Icons.store,
