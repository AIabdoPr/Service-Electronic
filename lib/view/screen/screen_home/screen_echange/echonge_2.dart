...
class Echonge2 extends StatelessWidget {
  const Echonge2({
    Key? key,
  }) : super(key: key);
                      ...
                      child: Form(
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                      ...
                                      child: FittedBox(
                                          child: Text(
                                        controller.sendedBalance.toString(),
                                        style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            color:
                                                Color.fromARGB(255, 2, 152, 7)),
                                      ))),
                                  FittedBox(
                                      child: Text(
                              ...
                              for (String item
                                ...
                                Container(
                                  ...
                                  margin: const EdgeInsets.only(
                                      right: 20, left: 20),
                                  color:
                                      const Color.fromARGB(255, 223, 227, 225),
                                  height: h * 0.06,
                                  width: w * 0.8,
                                  child: Row(
                                    mainAxisAlignment:
                            ...
                            for (var name
                                in controller.receivedCurrency.data.keys)
                              Container(
                                margin: const EdgeInsets.only(
                                  right: 40,
                                  left: 40,
                                ...
                                child: myTextFormField(
                                  ...
                                  labeltext: controller.receivedCurrency
                            ...
                            const Gap(10),
                            if (
                            // controller.sendedCurrency.id !=
                            //       controller.user.platformSettings
                            //           .platformCurrency.id &&
                            controller.sendedCurrency.proofIsRequired) ...[
                              Text("138".tr),
                              Container(
                                margin: const EdgeInsets.only(
                                  top: 15,
